...
public final class HttpClientUtils {
    ...
    public static void getAsync(final String requestUrl, final HttpClientUtils.OnRequestCallBack callBack) {
        ExecutorService executorService = Executors.newSingleThreadExecutor();
        executorService.execute(() -> getRequest(requestUrl, callBack));
    }

    public static void postAsync(final String requestUrl, final String params, final HttpClientUtils.OnRequestCallBack callBack) {
        ExecutorService executorService = Executors.newSingleThreadExecutor();
        executorService.execute(() -> postRequest(requestUrl, params, callBack));
    }

    public static void getRequest(String requestUrl, HttpClientUtils.OnRequestCallBack callBack) {
    ...
    public static void postRequest(String requestUrl, String params, HttpClientUtils.OnRequestCallBack callBack) {
        ...
        try {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                Log.i(TAG, "postRequest: backStr==" + backStr);
                message = backStr;
                isSuccess = true;
            } else {
                message = "请求失败 code:" + connection.getResponseCode();
